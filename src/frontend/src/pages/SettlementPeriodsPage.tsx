      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage accounting periods and lock transactions
          </p>
        </div>
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Define a new accounting period with start and end dates
              </DialogDescription>
            </DialogHeader>
        ...
        <CardContent>
          {isLoading ? (
            <div className="py-12 text-center text-sm text-muted-foreground">
              Loading settlement periods...
            </div>
          ) : sortedPeriods.length === 0 ? (
            <div className="py-12 text-center text-sm text-muted-foreground">
              No settlement periods found. Create your first period to get
              started.
            </div>
          ) : (
            <Table>
                  ...
                  return (
                    <TableRow key={Number(period.id)}>
                      <TableCell className="font-medium">
                        Period #{Number(period.id) + 1}
                      </TableCell>
                      <TableCell>
                        {formatSettlementPeriodDate(period.startDate)}
                      </TableCell>
                      <TableCell>
                        {formatSettlementPeriodDate(period.endDate)}
                      </TableCell>
                      <TableCell>
                        {isOpen ? (
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  This will lock all transactions in this
                                  period. You will not be able to add or edit
                                  consignments, sales, returns, or payouts
                                  within this date range. Only adjustments will
                                  be allowed. This action cannot be undone.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
